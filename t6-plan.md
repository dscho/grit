...
- [ ] `t6111-rev-list-treesame.sh` — 19/65 passing, 46 failing.
...
- [~] `t6423-merge-rename-directories.sh` — 79/82 passing, 1 failing, with 2 expected
  failures. Remaining real failure: `13e`.
