...
- [~] Make all current `t3` family tests fully pass. Work one dependency group at a time,
  ...
  - Branch/refs/range-diff/pack-refs group sweep verified: `t3200`, `t3201`, `t3202`, `t3203`,
    ...
    `t3211` all pass.
  - Current focus: `t3301-notes.sh` (153 total, 139 passed, 14 failing after fixing raw log
    ...
    accounting, and single-editor handling for `notes append -c`), first file in the notes group.
