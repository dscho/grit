...
- [~] Make all current `t3` family tests fully pass. Work one dependency group at a time,
  ...
  - Branch/refs/range-diff/pack-refs group sweep verified: `t3200`, `t3201`, `t3202`, `t3203`,
    ...
    `t3211` all pass.
  - Current focus: `t3301-notes.sh` (153 total, 127 passed, 26 failing after fixing raw log
    ...
    the notes group.
  - Related progress: `t3321-notes-stripspace.sh` improved from 2/27 to 24/27 with the stripspace
