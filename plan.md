...
- [~] Make all in-scope t7 submodule tests fully pass. Detailed queue and per-file status are in
  `submodule-plan.md`; work one file at a time. Next unclaimed file is `t7506-status-submodule.sh`.
  ...
  - Completed: `t7112-reset-submodule.sh` improved from 34/82 to 78/82, failing=0 with 4 upstream TODO known breakages; log:
